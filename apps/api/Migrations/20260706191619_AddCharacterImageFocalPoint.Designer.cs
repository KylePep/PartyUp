...
namespace PartyUp.Api.Migrations
{
    ...
    [Migration("20260706191619_AddCharacterImageFocalPoint")]
    partial class AddCharacterImageFocalPoint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartyUp.Api.Models.Character", b =>
                {
                    ...
                    b.Property<int?>("ImageFocalX")
                        .HasColumnType("integer");

                    b.Property<int?>("ImageFocalY")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PartyUp.Api.Models.StickerMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PartyUp.Api.Models.UserPushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PartyUp.Api.Models.StickerMessage", b =>
                {
                    ...
                    b.HasOne("PartyUp.Api.Models.Character", "SenderCharacter")
                        .WithMany()

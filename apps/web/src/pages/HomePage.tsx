...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-1 md:items-center ms-4 md:justify-center py-2 md:py-4 overflow-hidden">
      <section className="md:h-full bg-surface border-white border-2 pb-4 pt-16 md:pt-4 px-6 w-[91%] md:w-1/2 flex flex-col items-center justify-between relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-x-4 w-full md:w-3/4 border-white border-2 md:h-1/3 p-2 md:p-8">
